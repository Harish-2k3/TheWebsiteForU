    ...
    <div className="max-w-[1344px] mx-auto py-20">
      ...
      <div className="flex flex-col md:flex-row justify-between items-center pb-10 text-center md:text-left">
        ...
        <div className="flex w-full mt-4 md:mt-0 justify-start md:justify-end">
          <Link to="/contact">
          <div className='group'>
          <button className="border-2 z-10 text-black font-medium px-4 py-2 rounded-full transition duration-300 ">
            Contact Us
          </button>
      ...
      <div className="flex flex-col lg:flex-row items-center justify-between gap-20 lg:py-20 2xl:py-40 py-10">
        ...
        <div className="flex flex-col gap-5 lg:gap-30 text-left w-full lg:w-3/12">
          <div>
            <h1 className="text-2xl font-bold">Custom Web & Mobile Apps</h1>
            <p className="text-gray-600">
              We design and develop high-performance web and mobile applications tailored to your business needs.
            </p>
          </div>
          <div>
            <h1 className="text-2xl font-bold">Result-Driven Digital Marketing</h1>
            <p className="text-gray-600">
        ...
        <div className="relative flex items-center justify-center w-full lg:w-6/12">
          ...
          <img 
            ...
            className="absolute top-15/12 left-10/12 md:top-18/15 md:left-8/10 xl:top-16/12 xl:left-12/12 transform -translate-x-1/2 -translate-y-1/2 w-2/3 md:w-6/10 lg:w-10/10 xl:w-full rotate-circle"
          />
        </div>
        ...
        <div className="flex flex-col gap-5 lg:gap-30 text-left w-full lg:w-3/12">
          <div>
            <h1 className="text-2xl font-bold">End-to-End Development</h1>
            <p className="text-gray-600">
              From concept to deployment, we handle every aspect of the development process with precision.
            </p>
          </div>
          <div>
            <h1 className="text-2xl font-bold">24/7 Support & Maintenance</h1>
            <p className="text-gray-600">
