...
export default function CollabrationComponent() {
  return (
    <div className="max-w-[1344px] mx-auto py-20 relative text-center">
      ...
      <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 group">
        <Link to="/contact">
        <div className="bg-[#c8f806cb] md:bg-[#C6F806] w-22 h-22 md:w-25 md:h-25 lg:w-35 lg:h-35 rounded-full flex flex-col items-center justify-center text-black font-medium text-sm lg:text-[20px] gap-2 cursor-pointer transition duration-300 hover:bg-black hover:text-white">
