  ...
  return (
    <div className="max-w-[1344px] mx-auto py-20 px-5">
      ...
      <p className="text-5xl">
        ...
        <span className="text-[#C6F806] font-bold">Completed Projects</span>
      </p>
        ...
        {[
          ...
          <div key={index} className="relative group overflow-hidden rounded-lg shadow-lg">
            ...
            <div className="absolute inset-0 flex flex-col justify-center items-center opacity-0 group-hover:opacity-100 transition-opacity duration-700">
              ...
              <Link
                to="/contact"
                className="mt-3 flex items-center cursor-pointer gap-2 bg-[#C6F806] text-black font-medium px-4 py-2 rounded-full shadow-lg hover:bg-[#b8e005] transition duration-300"
              >
                See More <i className="fa-regular fa-circle-right"></i>
              </Link>
            </div>
          </div>
        ))}
