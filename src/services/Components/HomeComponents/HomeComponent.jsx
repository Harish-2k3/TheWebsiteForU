...
export default function HomeComponent() {
  return (
    <div className="bg-center relative pt-18 md:pt-25 bg-gradient-to-b from-[#11778B] to-[#0A1F44] overflow-hidden" id='home'>
      ...
      <div className='absolute md:hidden bottom-[33vh] md:bottom-[25vh] right-2 md:right-20 triangle-shape'>
      ...
      {/* Hero Text Image */}
      <div className='flex items-center justify-center pt-35 pb-15 z-20'>
      ...
      <div className='max-w-[1440px] px-5 md:px-10 2xl:px-0 mx-auto h-full py-auto grid grid-cols-1 lg:flex lg:flex-row justify-between items-center gap-5'>
        ...
        <div className='text-white flex flex-col gap-5 w-full lg:w-3/12 max-w-[1024px]'>
          <h3 className='text-[25px] z-10'>Elevate Your Business with Digital Excellence</h3>
          <h1 className='text-4xl font-bold z-10'>Think Digital</h1>
        ...
        {/* Center Image */}
        <div className="h-full w-full lg:w-6/12 flex md:py-10 lg:py-0 justify-center items-center max-w-[1024px]">
          <img src="hero-image (1).png" alt="loading..." className="max-h-[70vh] object-contain z-10" />
        </div>

        {/* Right Content */}
        <div className='text-white relative py-10 lg:py-0 lg:w-3/12 flex-col items-center max-w-[1024px] hidden lg:flex'>
          {/* Text Content */}
