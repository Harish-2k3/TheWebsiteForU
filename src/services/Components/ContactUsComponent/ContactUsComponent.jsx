            ...
            <div className={`mx-auto px-5 md:px-10 2xl:px-0 ${isContactPage ? "max-w-[1200px]" : "max-w-full"}`}>
                <div className="py-10 grid grid-cols-1 lg:grid-cols-2 max-w-[1344px] mx-auto">
                    ...
                    <div className="flex flex-col space-y-4 gap-5 justify-center">
                        ...
                        {/* Email */}
                        <div className="flex items-center gap-4">
                            <i className="fa-solid fa-paper-plane text-[#11778B] text-3xl w-10 flex justify-center"></i>
                            <div className="border-l-2 border-gray-300 pl-4">
                                <p className="text-gray-600 text-lg">Email our Sales Reps</p>
                                <span className="font-semibold text-xl">info@email.com</span>
                            </div>
                        </div>

                        {/* Office Location */}
                        <div className="flex items-center gap-4">
                            <i className="fa-solid  fa-comments text-[#11778B] text-3xl w-10 flex justify-center"></i>
                            <div className="border-l-2 border-gray-300 pl-4">
                                <p className="text-gray-600 text-lg">Live Chat</p>
                                <span className="font-semibold text-xl">Support Available</span>
                            </div>
                        </div>
                    </div>
